(function(g,i,j,b){var h="sharrre",f={className:"sharrre",share:{googlePlus:false,facebook:false,twitter:false,digg:false,delicious:false,stumbleupon:false,linkedin:false,pinterest:false,buffer:false},buttonsClass:"buttons",buttonClass:"button",shareTotal:0,template:"",title:"",url:j.location.href,text:j.title,urlCurl:"sharrre.php",count:{},total:0,shorterTotal:true,enableHover:true,enableCounter:true,enableTracking:false,hover:function(){},hide:function(){},click:function(){},render:function(){},buttons:{googlePlus:{url:"",urlCount:false,size:"medium",lang:"en-US",annotation:""},facebook:{url:"",urlCount:false,action:"like",layout:"button_count",width:"",send:"false",faces:"false",colorscheme:"",font:"",lang:"en_US"},twitter:{url:"",urlCount:false,count:"horizontal",hashtags:"",via:"",related:"",lang:"en"},digg:{url:"",urlCount:false,type:"DiggCompact"},delicious:{url:"",urlCount:false,size:"medium"},stumbleupon:{url:"",urlCount:false,layout:"1"},linkedin:{url:"",urlCount:false,counter:""},pinterest:{url:"",media:"",description:"",layout:"horizontal"},buffer:{url:"",media:"",description:"",layout:"horizontal",tweetText:""}}},c={googlePlus:"",facebook:"https://graph.facebook.com/fql?q=SELECT%20url,%20normalized_url,%20share_count,%20like_count,%20comment_count,%20total_count,commentsbox_count,%20comments_fbid,%20click_count%20FROM%20link_stat%20WHERE%20url=%27{url}%27&callback=?",twitter:"http://cdn.api.twitter.com/1/urls/count.json?url={url}&callback=?",digg:"http://services.digg.com/2.0/story.getInfo?links={url}&type=javascript&callback=?",delicious:"http://feeds.delicious.com/v2/json/urlinfo/data?url={url}&callback=?",stumbleupon:"",linkedin:"http://www.linkedin.com/countserv/count/share?format=jsonp&url={url}&callback=?",pinterest:""},l={googlePlus:function(m){var n=m.options.buttons.googlePlus;
g(m.element).find("."+m.options.buttonsClass).append('<div class="'+m.options.buttonClass+' googleplus"><div class="g-plusone" data-size="'+n.size+'" data-href="'+(n.url!==""?n.url:m.options.url)+'" data-annotation="'+n.annotation+'"></div></div>');
...
}},facebook:function(m){var n=m.options.buttons.facebook;g(m.element).find("."+m.options.buttonsClass).append('<div class="'+m.options.buttonClass+' facebook"><div id="fb-root"></div><div class="fb-like" data-href="'+(n.url!==""?n.url:m.options.url)+'" data-send="'+n.send+'" data-layout="'+n.layout+'" data-width="'+n.width+'" data-show-faces="'+n.faces+'" data-action="'+n.action+'" data-colorscheme="'+n.colorscheme+'" data-font="'+n.font+'" data-via="'+n.via+'"></div></div>');
...
g(m.element).find("."+m.options.buttonsClass).append('<div class="'+m.options.buttonClass+' twitter"><a href="https://twitter.com/share" class="twitter-share-button" data-url="'+(n.url!==""?n.url:m.options.url)+'" data-count="'+n.count+'" data-text="'+m.options.text+'" data-via="'+n.via+'" data-hashtags="'+n.hashtags+'" data-related="'+n.related+'" data-lang="'+n.lang+'">Tweet</a></div>');
...
}},digg:function(m){var n=m.options.buttons.digg;g(m.element).find("."+m.options.buttonsClass).append('<div class="'+m.options.buttonClass+' digg"><a class="DiggThisButton '+n.type+'" rel="nofollow external" href="http://digg.com/submit?url='+encodeURIComponent((n.url!==""?n.url:m.options.url))+'"></a></div>');
...
if(typeof q==="undefined"){q=0;}g(o.element).find("."+o.options.buttonsClass).append('<div class="'+o.options.buttonClass+' delicious"><div style="'+p+'font:12px Arial,Helvetica,sans-serif;cursor:pointer;color:#666666;display:inline-block;float:none;height:20px;line-height:normal;margin:0;padding:0;text-indent:0;vertical-align:baseline;"><div style="'+n+'background-color:#fff;margin-bottom:5px;overflow:hidden;text-align:center;border:1px solid #ccc;border-radius:3px;">'+q+'</div><div style="'+m+'display:block;padding:0;text-align:center;text-decoration:none;width:50px;background-color:#7EACEE;border:1px solid #40679C;border-radius:3px;color:#fff;"><img src="http://www.delicious.com/static/img/delicious.small.gif" height="10" width="10" alt="Delicious" /> Add</div></div></div>');
g(o.element).find(".delicious").on("click",function(){o.openPopup("delicious");});},stumbleupon:function(m){var n=m.options.buttons.stumbleupon;g(m.element).find("."+m.options.buttonsClass).append('<div class="'+m.options.buttonClass+' stumbleupon"><su:badge layout="'+n.layout+'" location="'+(n.url!==""?n.url:m.options.url)+'"></su:badge></div>');
...
clearInterval(s);}},500);}else{STMBLPN.processWidgets();}},linkedin:function(m){var n=m.options.buttons.linkedin;g(m.element).find("."+m.options.buttonsClass).append('<div class="'+m.options.buttonClass+' linkedin"><script type="in/share" data-url="'+(n.url!==""?n.url:m.options.url)+'" data-counter="'+n.counter+'"><\/script></div>');
...
g(m.element).find("."+m.options.buttonsClass).append('<div class="'+m.options.buttonClass+' pinterest"><a href="http://pinterest.com/pin/create/button/?url='+(n.url!==""?n.url:m.options.url)+"&media="+n.media+"&description="+n.description+'" class="pin-it-button" count-layout="'+n.layout+'">Pin It</a></div>');
...
p.parentNode.insertBefore(o,p);})();},buffer:function(m){var n=m.options.buttons.buffer;g(m.element).find("."+m.options.buttonsClass).append('<div class="'+m.options.buttonClass+' buffer"><a href="http://bufferapp.com/add" class="buffer-add-button" data-count="'+n.layout+'" >Buffer</a></div>');
(function(){var o=j.createElement("script");o.type="text/javascript";o.async=true;o.src="//static.bufferapp.com/js/button.js";var p=j.getElementsByTagName("script")[0];
...
},buffer:function(m){i.open("http://bufferapp.com/add?url="+encodeURIComponent((m.buttons.buffer.url!==""?m.buttons.buffer.url:m.url))+"&text="+m.buttons.buffer.tweetText+"&via=&picture=&count="+m.buttons.buffer.layout+"&source=button","buffer","toolbar=no,width=700,height=300");
...
}catch(o){}}});}else{if(m.options.template!==""){this.options.render(this,this.options);}else{this.loadButtons();}}g(this.element).hover(function(){if(g(this).find("."+m.options.buttonsClass).length===0&&m.options.enableHover===true){m.loadButtons();
...
};k.prototype.loadButtons=function(){var m=this;g(this.element).append('<div class="'+m.options.buttonsClass+'"></div>');g.each(m.options.share,function(n,o){if(o==true){l[n](m);
...
}else{if(typeof r[0]!=="undefined"){p+=parseInt(r[0].total_posts,10);}else{if(typeof r[0]!=="undefined"){}}}}m.options.count[o]=p;m.options.total+=p;m.renderer();
m.rendererPerso();}).error(function(){m.options.count[o]=0;m.rendererPerso();});}else{m.renderer();m.options.count[o]=0;m.rendererPerso();}};k.prototype.rendererPerso=function(){var m=0;
for(e in this.options.count){m++;}if(m===this.options.shareTotal){this.options.render(this,this.options);}};k.prototype.renderer=function(){var n=this.options.total,m=this.options.template;
if(this.options.shorterTotal===true){n=this.shorterTotal(n);}if(m!==""){m=m.replace("{total}",n);g(this.element).html(m);}else{g(this.element).html('<div class="box"><a class="count" href="#">'+n+"</a>"+(this.options.title!==""?'<a class="share" href="#">'+this.options.title+"</a>":"")+"</div>");
